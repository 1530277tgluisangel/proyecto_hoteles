...
class Paginas{
	...
	public function enlacesPaginasModel($enlaces){
		$nombres = ['ver_usuarios','ver_reservaciones','ver_habitaciones','ver_clientes','modificar_usuarios','modificar_reservaciones','modificar_habitaciones','modificar_clientes','agregar_cliente','agregar_habitacion','agregar_reservacion','agregar_usuario','cerrar_sesion','dashboard','login'];
